    ...
    <div class="container">
        ...
        <div class="row mb-30">
            <div class="col-md-6 col-sm-6">
                <div class="service-icon-left-boxed">
                    <div class="icon-container animated triggerAnimation" data-animate="zoomIn">
                        <img src="{{ Helper::frontend('img/svg/pi-checklist-2.svg') }}" alt="checklist icon" />
            ...
            <div class="col-md-6 col-sm-6">
                <div class="service-icon-left-boxed">
                    <div class="icon-container animated triggerAnimation" data-animate="zoomIn">
                        <img src="{{ Helper::frontend('img/svg/pi-globe-5.svg') }}" alt="globe icon" />
                    </div><!-- .icon-container end -->
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="service-icon-left-boxed">
                    <div class="icon-container animated triggerAnimation" data-animate="zoomIn">
                        <img src="{{ Helper::frontend('img/svg/pi-forklift-truck-5.svg') }}" alt="forktruck icon" />
                    </div><!-- .icon-container end -->
            ...
            <div class="col-md-6 col-sm-6">
                <div class="service-icon-left-boxed">
                    <div class="icon-container animated triggerAnimation" data-animate="zoomIn">
                        <img src="{{ Helper::frontend('img/svg/pi-touch-desktop.svg') }}" alt="touch icon" />
                    </div><!-- .icon-container end -->
